 ...
 # -U_REENTRANT .\test.cpp -mtune=core2 -march=nocona
 # -auxbase-strip .\test.s -g -fverbose-asm
...
.LVL0:
 # .\test.cpp:3:     int p = 5;
	.loc 1 3 9
	movl	$5, -4(%rbp)	 #, p
 # .\test.cpp:4:     printf("%d %d %d",++p,p++,++p);
	.loc 1 4 11
	addl	$1, -4(%rbp)	 #, p
	movl	-4(%rbp), %eax	 # p, p.0_1
	leal	1(%rax), %edx	 #, tmp90
	movl	%edx, -4(%rbp)	 # tmp90, p
	addl	$1, -4(%rbp)	 #, p
	movl	-4(%rbp), %ecx	 # p, tmp91
	movl	-4(%rbp), %edx	 # p, tmp92
	movl	%ecx, %r9d	 # tmp91,
	movl	%eax, %r8d	 # p.0_1,
	leaq	.LC0(%rip), %rcx	 #,
	call	printf	 #
